...
El proyecto que vamos a desarrollar es una aplicacion web 
multiplataforma. Para el desarrollo de la aplicacion vamos a 
usar **MVC aspnet.net**. Como *ORM* vamos a usar **EntityFramework** 
y para la Base de Datos **SQL Server**. 

Para el desarrollo del proyecto vamos a usar el pricipio SOLID por 
ajustarse bastante a nuestras caracteristicas de trabajo.  

Se va a emplear una metodologia agil con Sprint de 15 dias on una 
planificacion vertical. Para la planificacion  y el control de 
versionesvamos a usar Microsoft Azure DevOps (para el control de 
...
el desarrollo del proyecto , asi como estableciendo las tareas y 
la asigancion de esta por integrantes del equipo de desarrollo.
Cada una de las tareas que hay definidas tienes una fecha de entrega 
correspondiente a la etapa de desarrollo de la aplicacion, de no 
entregarse a tiempo una tarea por parte de los miembros del equipo,
se veria comprometida la fecha de entrega de la aplicacion.
Por lo que cada tarea esta asignada y bien detallada para que los 
integrantes trabajen en el tiempo establecido. 

 

Entonces como vamos a usar una metodologia Agil trataremos de
usar algunos conceptos vistos en a lo largo del curso y lo adaptaremos 
a nuestra forma de trabajo en equipo 

Apoyandonos en algunas caracteristicas del Crystal Crlear vamos 
...
- **Entregas Frecuentes:** Trataremos de hacer entregas del software
 ...
 con este, identificar los posibles problemas de la aplicacion 
 y verificar si este es de su agrado o no. 
 La frecuencia de la entrega son cada 15 dias, los martes , pero 
si hubiera un adelanto en la entrega de las tareas por parte del 
equipo de desarrollo , entonces tratariamos de hacer entregas 
antes para asi poder detectar entes posibles inconvenientes con los 
usuarios y poder arreglar posibles errores que se presenten a lo
largo del desarrollo de la aplicacion . 
 
 - **Mejoras Reflexivas:** El equipo de trabajo se se va a hacer llamadas 
 - grupales cada 3 dias para reflexionar y compartir ideas , tomar notas, reflexionar y 
 discutir cómo las cosas están funcionando (bien o mal) y poder hacer cambios 
 para la próxima reunion. Asi el equipo puede solucionar los 
problemas que pueda ir apareciendo en  el desarrollo del software. 

 - **Comunicación Osmótica:** Los miembros del equipo pueden hacer videollamada 
 ...
 fluye entre los desarrolladores . El diseñador líder debe tener constancia de
   estas conversaciones , asi como del tema de la misma. 
